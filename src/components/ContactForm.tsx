...
export default function ContactForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    formData.append("access_key", "6d817fd9-28ae-4e3f-8dfc-4c4ec9dc783c");
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full py-4 bg-accent-warm text-white font-bold text-sm tracking-[0.15em] uppercase hover:bg-accent-warm-dark transition-colors glitch-hover disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {sending ? "Sending... 送信中" : "Submit 送信"}
              </button>
            </form>
          </>
        )}
