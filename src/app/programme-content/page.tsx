    ...
    <div className="min-h-screen">
      <section className="relative h-[50vh] flex items-center justify-center">
        ...
        <div className="relative text-center px-4">
          <h1 className="text-4xl sm:text-5xl font-light mb-4 text-neutral-900">Programme Content</h1>
          <p className="text-neutral-500 text-xl font-jp">番組コンテンツ制作</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {programmes.map((item, i) => (
              <FadeInSection key={i}>
                <div className="bg-white rounded-lg overflow-hidden border border-neutral-100 shadow-sm">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                  ...
                  />
                  <div className="p-6">
                    <h3 className="text-xl font-semibold mb-1 text-neutral-800">{item.title}</h3>
                    <p className="text-accent-warm text-sm font-jp mb-3">{item.titleJp}</p>
